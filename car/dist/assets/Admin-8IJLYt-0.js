import{r as e,u as a,j as r,a as t}from"./index-B6QbhPiA.js";/* empty css                  */const l=()=>{const[l,s]=e.useState({km:"",brand:"",location:""}),[n,o]=e.useState([]),[i,d]=e.useState([]),[c,m]=e.useState([]),[u,h]=e.useState([]),[g,p]=e.useState(!0),[j,x]=e.useState(""),[f,b]=e.useState({name:"",email:"",password:""}),[v,y]=e.useState({title:"",year:"",mileage:"",status:"",sold:!1,centerImage:null,leftImage:null}),[N,w]=e.useState({brand:"",km:"",location:"",title:"",content:"",logoImage:null}),[C,E]=e.useState(null),[A,$]=e.useState("user"),I=a(),F=localStorage.getItem("token"),S=async()=>{var e;try{p(!0);const e=await t.get("https://future-auto-jc.onrender.com:10000/api/admin/users",{headers:{Authorization:`Bearer ${F}`}});o(e.data.users),p(!1)}catch(a){x("Failed to fetch users. Please check your admin privileges."),p(!1),console.error("Error fetching users:",a),401===(null==(e=a.response)?void 0:e.status)&&I("/login")}},k=async()=>{console.log("Fetching logos...");try{const e=await t.get("https://future-auto-jc.onrender.com:10000/api/admin/logos",{headers:{Authorization:`Bearer ${F}`}});m(e.data.logos),h(e.data.logos)}catch(e){console.error("Error fetching logos:",e)}},D=async()=>{console.log("Fetching cars...");try{const e=await t.get("https://future-auto-jc.onrender.com:10000/api/admin/cars",{headers:{Authorization:`Bearer ${F}`}});d(e.data.cars)}catch(e){console.error("Error fetching cars:",e),x("Failed to fetch cars")}};e.useEffect((()=>{F?(S(),D(),k()):I("/login")}),[F,I]),e.useEffect((()=>{const e=c.filter((e=>!l.brand||e.brand===l.brand));h(e)}),[l,c]);const q=(e,a)=>{y({...v,[a]:e.target.files[0]})};return g?/* @__PURE__ */r.jsx("div",{className:"loading",children:"Loading..."}):j?/* @__PURE__ */r.jsx("div",{className:"error",children:j}):/* @__PURE__ */r.jsxs("div",{className:"admin-container",children:[
...
/* @__PURE__ */r.jsxs("form",{onSubmit:async e=>{var a,r;alert("Creating logo..."),alert("Logo data before submission: "+JSON.stringify(N)),console.log("Creating logo..."),console.log("Logo data before submission:",N),e.preventDefault();try{const e=new FormData;e.append("title",N.title),e.append("content",N.content),e.append("km",N.km),e.append("brand",N.brand),e.append("location",N.location),N.logoImage&&e.append("logoImage",N.logoImage),await t.post("https://future-auto-jc.onrender.com:10000/api/admin/logos",e,{headers:{Authorization:`Bearer ${F}`,"Content-Type":"multipart/form-data"}}),alert("Logo created successfully!"),w({title:"",content:"",logoImage:null,brand:"",km:"",location:""}),k()}catch(l){console.error("Error creating logo:",l),alert(`Error creating logo: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}},className:"admin-form","aria-label":"Create new logo form",children:[
...
/* @__PURE__ */r.jsx("div",{className:"logo",children:/* @__PURE__ */r.jsx("img",{src:`https://future-auto-jc.onrender.com:10000${e.logoImage}`,alt:e.title})}),
...
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete this logo?"))if(F)try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/admin/logos/${e}`,{headers:{Authorization:`Bearer ${F}`}}),alert("Logo deleted successfully!"),k()}catch(l){console.error("Error deleting logo:",l),l.response&&(console.error("Response data:",l.response.data),console.error("Response status:",l.response.status),console.error("Response headers:",l.response.headers)),alert(`Error deleting logo: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}else alert("You must be logged in to delete a logo.")})(e._id),children:"Delete"})]})]},e._id)))})})]}),
...
/* @__PURE__ */r.jsxs("form",{onSubmit:async e=>{var a,r;e.preventDefault();try{await t.post("https://future-auto-jc.onrender.com:10000/api/admin/create-admin",f,{headers:{Authorization:`Bearer ${F}`}}),alert("Admin created successfully!"),b({name:"",email:"",password:""}),S()}catch(l){console.error("Error creating admin:",l),alert(`Error creating admin: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}},className:"admin-form","aria-label":"Create new admin form",children:[
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"admin-name",children:"Name:"}),
/* @__PURE__ */r.jsx("input",{id:"admin-name",type:"text",placeholder:"Enter full name","aria-label":"Admin name",value:f.name,onChange:e=>b({...f,name:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"admin-email",children:"Email:"}),
/* @__PURE__ */r.jsx("input",{id:"admin-email",type:"email",placeholder:"Enter email address","aria-label":"Admin email",value:f.email,onChange:e=>b({...f,email:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"admin-password",children:"Password:"}),
/* @__PURE__ */r.jsx("input",{id:"admin-password",type:"password",placeholder:"Enter password","aria-label":"Admin password",value:f.password,onChange:e=>b({...f,password:e.target.value}),required:!0})]}),
...
/* @__PURE__ */r.jsxs("form",{onSubmit:async e=>{var a,r;e.preventDefault();try{const e=new FormData;e.append("title",v.title),e.append("year",v.year),e.append("mileage",v.mileage),e.append("status",v.status),e.append("sold",v.sold),v.centerImage&&e.append("centerImage",v.centerImage),v.leftImage&&e.append("leftImage",v.leftImage),await t.post("https://future-auto-jc.onrender.com:10000/api/car",e,{headers:{Authorization:`Bearer ${F}`,"Content-Type":"multipart/form-data"}}),alert("Car added successfully!"),y({title:"",year:"",mileage:"",status:"",sold:!1,centerImage:null,leftImage:null}),D()}catch(l){console.error("Error creating car:",l),alert(`Error creating car: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}},className:"admin-form","aria-label":"Add new car form",children:[
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"car-title",children:"Title:"}),
/* @__PURE__ */r.jsx("input",{id:"car-title",type:"text",placeholder:"Enter car title","aria-label":"Car title",value:v.title,onChange:e=>y({...v,title:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"car-year",children:"Year:"}),
/* @__PURE__ */r.jsx("input",{id:"car-year",type:"text",placeholder:"Enter manufacturing year","aria-label":"Car year",value:v.year,onChange:e=>y({...v,year:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"car-mileage",children:"Mileage:"}),
/* @__PURE__ */r.jsx("input",{id:"car-mileage",type:"text",placeholder:"Enter mileage","aria-label":"Car mileage",value:v.mileage,onChange:e=>y({...v,mileage:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"car-status",children:"Status:"}),
/* @__PURE__ */r.jsx("input",{id:"car-status",type:"text",placeholder:"Enter status (e.g., Available, Sold)","aria-label":"Car status",value:v.status,onChange:e=>y({...v,status:e.target.value}),required:!0})]}),
/* @__PURE__ */r.jsxs("div",{className:"checkbox-label",children:[
/* @__PURE__ */r.jsx("label",{htmlFor:"car-sold",children:"Sold:"}),
/* @__PURE__ */r.jsx("input",{id:"car-sold",type:"checkbox",checked:v.sold,onChange:e=>y({...v,sold:e.target.checked}),"aria-label":"Car sold status"})]}),
/* @__PURE__ */r.jsxs("div",{className:"form-group",children:[
...
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete this car?"))try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/car/${e}`,{headers:{Authorization:`Bearer ${F}`}}),alert("Car deleted successfully!"),D()}catch(l){console.error("Error deleting car:",l),alert(`Error deleting car: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}})(e._id),className:"btn-delete","aria-label":`Delete car ${e.title}`,children:"Delete Car"}),
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete the center image?"))try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/car/${e}/centerImage`,{headers:{Authorization:`Bearer ${F}`}}),alert("Center image deleted successfully!"),D()}catch(l){console.error("Error deleting center image:",l),alert(`Error deleting center image: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}})(e._id),className:"btn-delete","aria-label":`Delete center image of car ${e.title}`,children:"Delete Center Image"}),
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete the left image?"))try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/car/${e}/leftImage`,{headers:{Authorization:`Bearer ${F}`}}),alert("Left image deleted successfully!"),D()}catch(l){console.error("Error deleting left image:",l),alert(`Error deleting left image: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}})(e._id),className:"btn-delete","aria-label":`Delete left image of car ${e.title}`,children:"Delete Left Image"}),
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete the content?"))try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/car/${e}/content`,{headers:{Authorization:`Bearer ${F}`}}),alert("Content deleted successfully!"),D()}catch(l){console.error("Error deleting content:",l),alert(`Error deleting content: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}})(e._id),className:"btn-delete","aria-label":`Delete content of car ${e.title}`,children:"Delete Content"})]})]},e._id)))})]})})]}),
/* @__PURE__ */r.jsxs("div",{className:"admin-section",children:[
...
/* @__PURE__ */r.jsxs("td",{className:"actions",children:[
/* @__PURE__ */r.jsxs("select",{value:C===e._id?A:e.role,onChange:a=>{E(e._id),$(a.target.value)},"aria-label":`Select role for user ${e.name}`,children:[
...
/* @__PURE__ */r.jsx("button",{onClick:()=>(async e=>{var a,r;if(window.confirm("Are you sure you want to delete this user?"))try{await t.delete(`https://future-auto-jc.onrender.com:10000/api/admin/users/${e}`,{headers:{Authorization:`Bearer ${F}`}}),alert("User deleted successfully!"),S()}catch(l){console.error("Error deleting user:",l),alert(`Error deleting user: ${(null==(r=null==(a=l.response)?void 0:a.data)?void 0:r.message)||l.message}`)}})(e._id),className:"btn-delete",disabled:"admin"===e.role,"aria-label":`Delete user ${e.name}`,children:"Delete"})]})]},e._id)))})]})})]})]})]})};export{l as default};
