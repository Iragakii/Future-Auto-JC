import{r as e,j as a,L as o,a as t,u as r,A as i,y as s}from"./index-oAyQ1r-q.js";import{J as m}from"./La-IyYVGAsW.js";import{a as l,P as h,E as n,b as _,u as c,C as x}from"./Pagefour-CJlE6DUk.js";import{l as d,F as g,f as j}from"./index-CnbVrLGL.js";import{u as M}from"./useAnimations-DCXGA-7e.js";const b=()=>{e.useRef();const o=[0,0,0];return l((({clock:e,camera:a})=>{const t=e.getElapsedTime();a.position.x=9*Math.sin(.5*t),a.position.z=9*Math.cos(.5*t),a.position.y=2,a.lookAt(o[0],o[0],o[0])})),/* @__PURE__ */a.jsxs(a.Fragment,{children:[
