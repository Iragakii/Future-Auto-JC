import {
  require_react_dom
} from "./chunk-ZABNP3TW.js";
import {
  require_react
} from "./chunk-HKRNK45B.js";
import {
  __commonJS,
  __name,
  __publicField,
...
var _map;
var _a2;
var unstable_RouterContextProvider = (_a2 = class {
  constructor(init) {
...
}, __name(_a2, "unstable_RouterContextProvider"), _a2);
...
function flattenRoutes(routes, branches = [], parentsMeta = [], parentPath = "") {
  ...
  routes.forEach((route, index) => {
    var _a9;
    if (route.path === "" || !((_a9 = route.path) == null ? void 0 : _a9.includes("?"))) {
...
function generatePath(originalPath, params = {}) {
  ...
  const stringify2 = /* @__PURE__ */ __name((p) => p == null ? "" : typeof p === "string" ? p : String(p), "stringify");
...
var _a3;
var DataWithResponseInit = (_a3 = class {
  constructor(data2, init) {
    this.type = "DataWithResponseInit";
    this.data = data2;
    this.init = init || null;
  }
}, __name(_a3, "DataWithResponseInit"), _a3);
...
var _a4;
var ErrorResponseImpl = (_a4 = class {
...
}, __name(_a4, "ErrorResponseImpl"), _a4);
...
function createRouter(init) {
  ...
  function completeNavigation(location, newState, { flushSync: flushSync2 } = {}) {
    var _a9, _b;
    let isActionReload = state.actionData != null && state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && state.navigation.state === "loading" && ((_a9 = location.state) == null ? void 0 : _a9._isRedirect) !== true;
    let actionData;
...
function getMatchesToLoad(request, scopedContext, mapRouteProperties2, manifest, history, state, matches, submission, location, lazyRoutePropertiesToSkip, initialHydration, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult) {
  ...
  let baseShouldRevalidateArgs = {
    currentUrl,
    currentParams: ((_a9 = state.matches[0]) == null ? void 0 : _a9.params) || {},
    nextUrl,
...
function isSameRoute(newRoute, existingRoute) {
  ...
  return newRoute.children.every(
    (aChild, i) => {
      var _a9;
      return (_a9 = existingRoute.children) == null ? void 0 : _a9.some((bChild) => isSameRoute(aChild, bChild));
    }
  );
}
...
async function callDataStrategyImpl(dataStrategyImpl, request, matches, fetcherKey, scopedContext, isStaticHandler) {
  if (matches.some((m) => {
    var _a9;
    return (_a9 = m._lazyPromises) == null ? void 0 : _a9.middleware;
  })) {
  ...
  try {
    await Promise.all(
      matches.flatMap((m) => {
        var _a9, _b;
        return [(_a9 = m._lazyPromises) == null ? void 0 : _a9.handler, (_b = m._lazyPromises) == null ? void 0 : _b.route];
      })
    );
  } catch (e) {
  }
    ...
    if (isDataWithResponseInit(result)) {
      if (result.data instanceof Error) {
        return {
          type: "error",
          error: result.data,
          statusCode: (_a9 = result.init) == null ? void 0 : _a9.status,
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  if (locationArg) {
    ...
    invariant(
      parentPathnameBase === "/" || ((_a9 = parsedLocationArg.pathname) == null ? void 0 : _a9.startsWith(parentPathnameBase)),
...
var _a5;
var RenderErrorBoundary = (_a5 = class extends React2.Component {
  constructor(props) {
    super(props);
    this.state = {
...
}, __name(_a5, "RenderErrorBoundary"), _a5);
...
function useRouteError() {
  ...
  return (_a9 = state.errors) == null ? void 0 : _a9[routeId];
}
...
__name(Await, "Await");
var _a7;
var AwaitErrorBoundary = (_a7 = class extends React3.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (!(resolve instanceof Promise)) {
      ...
      promise = resolve.then(
        ...
        (error) => Object.defineProperty(resolve, "_error", { get: /* @__PURE__ */ __name(() => error, "get") })
      );
    }
...
}, __name(_a7, "AwaitErrorBoundary"), _a7);
...
function getKeyedLinksForMatches(matches, routeModules, manifest) {
  let descriptors = matches.map((match) => {
    ...
    return [
      ...
      ((_a9 = module == null ? void 0 : module.links) == null ? void 0 : _a9.call(module)) || []
    ];
  }).flat(2);
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
  ...
  let matchPathChanged = /* @__PURE__ */ __name((match, index) => {
    ...
    return (
      ...
      // e.g. /files/images/avatar.jpg -> files/finances.xls
      ((_a9 = currentMatches[index].route.path) == null ? void 0 : _a9.endsWith("*")) && currentMatches[index].params["*"] !== match.params["*"]
    );
  }, "matchPathChanged");
  if (mode === "assets") {
    ...
    return nextMatches.filter((match, index) => {
      ...
      if (match.route.shouldRevalidate) {
        let routeChoice = match.route.shouldRevalidate({
          ...
          currentParams: ((_a9 = currentMatches[0]) == null ? void 0 : _a9.params) || {},
...
var _a8;
var RemixErrorBoundary = (_a8 = class extends React5.Component {
  constructor(props) {
    super(props);
...
}, __name(_a8, "RemixErrorBoundary"), _a8);
...
function BoundaryShell({
  ...
  if (((_a9 = routeModules.root) == null ? void 0 : _a9.Layout) && !isOutsideRemixApp) {
    return children;
  }
...
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), needsRevalidation) {
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    if (routeModule) {
      ...
      let initialData = hasInitialData ? (_a9 = initialState == null ? void 0 : initialState.loaderData) == null ? void 0 : _a9[route.id] : void 0;
...
function useFogOFWarDiscovery(router2, manifest, routeModules, ssr, isSpaMode) {
  React8.useEffect(() => {
    var _a9;
    if (!isFogOfWarEnabled(ssr) || ((_a9 = navigator.connection) == null ? void 0 : _a9.saveData) === true) {
      return;
    }
...
function PrefetchPageLinksImpl({
  ...
  let dataHrefs = React9.useMemo(() => {
    ...
    nextMatches.forEach((m) => {
      ...
      if (!newMatchesForData.some((m2) => m2.route.id === m.route.id) && m.route.id in loaderData && ((_a9 = routeModules[m.route.id]) == null ? void 0 : _a9.shouldRevalidate)) {
        foundOptOutRoute = true;
...
function Scripts(props) {
  ...
  let initialScripts = React9.useMemo(() => {
    ...
    let routeModulesScript = !isStatic ? " " : `${((_a9 = manifest.hmr) == null ? void 0 : _a9.runtime) ? `import ${JSON.stringify(manifest.hmr.runtime)};` : ""}${!enableFogOfWar ? `import ${JSON.stringify(manifest.url)}` : ""};
...
function useFetcher({
  ...
  let routeId = (_a9 = route.matches[route.matches.length - 1]) == null ? void 0 : _a9.route.id;
...
__name(serializeErrors2, "serializeErrors2");
...
async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  try {
    let respond2 = /* @__PURE__ */ __name(function(context) {
...
var createRequestHandler = /* @__PURE__ */ __name((build, mode) => {
  ...
  return /* @__PURE__ */ __name(async function requestHandler(request, initialContext) {
    ...
    let handleError = /* @__PURE__ */ __name((error) => {
      var _a10, _b2;
      if (mode === "development") {
        (_b2 = (_a10 = getDevServerHooks()) == null ? void 0 : _a10.processRequestError) == null ? void 0 : _b2.call(_a10, error);
      }
      errorHandler(error, {
        context: loadContext,
        params,
...
Error: ${e instanceof Error ? e.toString() : e}`
    ...
    if (url.pathname.endsWith(".data")) {
      ...
      } else if (mode === "development" && ((_a9 = getDevServerHooks()) == null ? void 0 : _a9.getCriticalCss)) {
...
__name(deserializeErrors2, "deserializeErrors2");
...
function createHydratedRouter({
  ...
  if (ssrInfo.context.isSpaMode) {
    if (((_a9 = ssrInfo.manifest.routes.root) == null ? void 0 : _a9.hasLoader) && loaderData && "root" in loaderData) {
      hydrationData = {
        loaderData: {
