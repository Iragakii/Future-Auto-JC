...
function oe(t2) {
  ...
  }(t2), e2 = new ce(t2, { set: /* @__PURE__ */ __name((t3, e3, n2) => (j(), t3[e3] = n2, true), "set") }), function(t3, e3) {
...
function _e(t2, e2, n2) {
  var _a83;
  if (f && me()) {
    if ((_a83 = fe == null ? void 0 : fe.get(e2)) == null ? void 0 : _a83.get(t2)) {
      if (n2) return;
...
function ve(t2, e2) {
  var _a83;
  const n2 = (_a83 = fe == null ? void 0 : fe.get(e2)) == null ? void 0 : _a83.get(t2);
...
function Te(t2, e2) {
  var _a83;
  (_a83 = fe == null ? void 0 : fe.get(e2)) == null ? void 0 : _a83.delete(t2);
}
__name(Te, "Te");
function Ae(t2, e2) {
    ...
    e2 = r2 ? (t3, e3) => r2(t3, e3, n2) : (t3, e3) => {
      ...
      for (; Kn(e3) && 4 != e3.h; ) {
        ...
        if (!o2) {
          ...
          if (i2) {
            var s2 = i2[r3];
            s2 && (h2 = (_a83 = i2.P) == null ? void 0 : _a83[r3], (!d || h2) && (i2 = kr(s2)) && (o2 = n2[r3] = i2));
          }
        }
...
function Rr(t2) {
  ...
  if (!e2) {
    const n2 = Pr(t2);
    e2 = /* @__PURE__ */ __name((t3, e3) => Br(t3, e3, n2), "e"), t2[Lr] = e2;
  }
  return e2;
}
__name(Rr, "Rr");
...
function Dr(t2, e2) {
  ...
  if (n2 = t2.X) {
    ...
    if (r2) {
      var i2 = (r2 = wr(r2))[0].h;
      if (r2 = r2[1], n2 = (_a83 = n2.P) == null ? void 0 : _a83[e2], !d || n2) {
        if (r2) {
...
function Br(t2, e2, n2) {
  ...
  for (var r2 = et(t2), i2 = +!!(512 & r2) - 1, s2 = t2.length, o2 = 512 & r2 ? 1 : 0, a2 = s2 + (256 & r2 ? -1 : 0); o2 < a2; o2++) {
    ...
    if (!a3) continue;
    const h2 = n2.X;
    (h2 == null ? void 0 : h2[s3]) && !((_a83 = h2 == null ? void 0 : h2.P) == null ? void 0 : _a83[s3]) && Wr++ < 5 && j(), a3(e2, r3, s3);
  }
  if (256 & r2) {
    r2 = t2[s2 - 1];
...
var Ji = Ai($i, qi);
var _a12;
var Zi = (_a12 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a12, "Zi"), _a12);
var _a13;
var Qi = (_a13 = class extends nr {
  constructor(t2) {
    super(t2);
  }
  g() {
...
var es = Ai(Qi, ts);
var _a14;
var ns = (_a14 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a14, "ns"), _a14);
var _a15;
var rs = (_a15 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a15, "rs"), _a15);
var _a16;
var is = (_a16 = class extends nr {
  constructor(t2) {
    super(t2);
  }
  h() {
...
var _a22;
var gs = (_a22 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a22, "gs"), _a22);
var _a23;
var ms = (_a23 = class extends nr {
  constructor(t2) {
    super(t2);
  }
  ra() {
...
Ni[508981768] = Ns;
var _a31;
var Us = (_a31 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a31, "Us"), _a31);
var _a32;
var Ds = (_a32 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a32, "Ds"), _a32);
...
Ni[478825422] = zs;
var _a35;
var Ks = (_a35 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a35, "Ks"), _a35);
var _a36;
var Ys = (_a36 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a36, "Ys"), _a36);
var _a37;
var $s = (_a37 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a37, "$s"), _a37);
var _a38;
var qs = (_a38 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a38, "qs"), _a38);
var _a39;
var Js = (_a39 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a39, "Js"), _a39);
...
var _a40;
var so = (_a40 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a40, "so"), _a40);
var _a41;
var oo = (_a41 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a41, "oo"), _a41);
var _a42;
var ao = (_a42 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a42, "ao"), _a42);
var _a43;
var ho = (_a43 = class extends nr {
  constructor() {
    super();
  }
}, __name(_a43, "ho"), _a43);
...
var _a46;
var mo = (_a46 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a46, "mo"), _a46);
var _a47;
var yo = (_a47 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a47, "yo"), _a47);
...
function Lo(t2) {
  ...
  if ((e2 = (_a83 = pn(t2, is, 4)) == null ? void 0 : _a83.h()) && (s2.boundingBox = { originX: An(e2, 1) ?? 0, originY: An(e2, 2) ?? 0, width: An(e2, 3) ?? 0, height: An(e2, 4) ?? 0, angle: 0 }), (_b = pn(t2, is, 4)) == null ? void 0 : _b.g().length) for (const e3 of pn(t2, is, 4).g()) s2.keypoints.push({ x: Ze(e3, 1) ?? 0, y: Ze(e3, 2) ?? 0, score: Ze(e3, 4) ?? 0, label: re(ze(e3, 3)) ?? "" });
  return s2;
}
__name(Lo, "Lo");
function Ro(t2) {
...
async function zo(t2, e2, n2, r2) {
  ...
  })(t2, n2.wasmLoaderPath, n2.assetLoaderPath, e2, { locateFile: /* @__PURE__ */ __name((t3) => t3.endsWith(".wasm") ? n2.wasmBinaryPath.toString() : n2.assetBinaryPath && t3.endsWith(".data") ? n2.assetBinaryPath.toString() : t3, "locateFile") }), await t2.o(r2), t2;
}
__name(zo, "zo");
function Ko(t2, e2) {
...
var Qo = (_a52 = class {
  ...
  l(t2, e2 = true) {
    var _a83, _b, _c, _d, _e2, _f;
    if (e2) {
      const e3 = t2.baseOptions || {};
      if (((_a83 = t2.baseOptions) == null ? void 0 : _a83.modelAssetBuffer) && ((_b = t2.baseOptions) == null ? void 0 : _b.modelAssetPath)) throw Error("Cannot set both baseOptions.modelAssetPath and baseOptions.modelAssetBuffer");
...
function ha(t2) {
  var _a83;
  (_a83 = t2.g) == null ? void 0 : _a83.bindFramebuffer(t2.g.FRAMEBUFFER, null);
}
__name(ha, "ha");
var _a53;
var ca = (_a53 = class {
      ...
      if (e2 instanceof Uint8Array) n2 = new Uint8Array(e2);
        ...
        if (!(e2 instanceof WebGLTexture)) throw Error(`Type is not supported: ${e2}`);
        {
          ...
          t3.texImage2D(t3.TEXTURE_2D, 0, r2, this.width, this.height, 0, t3.RED, t3.FLOAT, null), t3.bindTexture(t3.TEXTURE_2D, null), aa(e3, t3, n2), sa(e3, t3, false, () => {
            _a56(this), t3.clearColor(0, 0, 0, 0), t3.clear(t3.COLOR_BUFFER_BIT), t3.drawArrays(t3.TRIANGLE_FAN, 0, 4), va(this);
          }), ha(e3), va(this);
        }
      }
      t2.push(n2);
...
var Ia = (_a58 = class {
  ...
  close() {
    var _a83, _b, _c;
    (_a83 = this.g) == null ? void 0 : _a83.close(), this.g = void 0, (_b = this.h) == null ? void 0 : _b.close(), this.h = void 0, (_c = this.m) == null ? void 0 : _c.close(), this.m = void 0;
  }
}, __name(_a58, "Ia"), _a58);
function Pa(t2, e2) {
  switch (e2) {
...
}, __name(_a60, "Wa"), _a60), class extends Wa {
  get ia() {
    return this.i;
  }
  ta(t2, e2, n2) {
...
function $a(t2, e2, n2) {
  var _a83;
  if ((_a83 = t2.baseOptions) == null ? void 0 : _a83.g()) throw Error("Task is not initialized with image mode. 'runningMode' must be set to 'IMAGE'.");
  Ya(t2, e2, n2, t2.B + 1);
}
__name($a, "$a");
function qa(t2, e2, n2, r2) {
  var _a83;
  if (!((_a83 = t2.baseOptions) == null ? void 0 : _a83.g())) throw Error("Task is not initialized with video mode. 'runningMode' must be set to 'VIDEO'.");
  Ya(t2, e2, n2, r2);
}
__name(qa, "qa");
...
var yh = (_a66 = class extends Za {
  ...
  o(t2) {
    ...
    if (xn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Hs(), n2 = e2, r2 = So(t2.cannedGesturesClassifierOptions, (_a83 = pn(this.h, Hs, 3)) == null ? void 0 : _a83.h());
    ...
    Bi(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), Gi(n2, "IMAGE:input_image"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), zi(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        const e4 = { classifications: mn(t4, ds, 1).map((t5) => {
          var _a83;
          return xo(((_a83 = pn(t5, Qi, 4)) == null ? void 0 : _a83.g()) ?? [], Tn(An(t5, 2), 0), kn(t5, 3));
        }) };
      ...
      t3 = vs(t3), this.embeddings = function(t4) {
        return { embeddings: mn(t4, ys, 1).map((t5) => {
          ...
          if (void 0 !== dn(t5, gs, hn(t5, 1))) t5 = en(t5 = pn(t5, gs, hn(t5, 1)), 1, Ht, tn()), e4.floatEmbedding = t5.slice();
            ...
            e4.quantizedEmbedding = ((_b = (_a83 = pn(t5, ms, hn(t5, 2))) == null ? void 0 : _a83.ra()) == null ? void 0 : _b.ua()) ?? n3;
          }
          return e4;
...
var xh = (_a71 = class {
  ...
  close() {
    var _a83, _b;
    (_a83 = this.confidenceMasks) == null ? void 0 : _a83.forEach((t2) => {
      t2.close();
...
var Fh = (_a72 = class extends Za {
  ...
  J() {
    !function(t2) {
      ...
      1 === e2.length && (((_b = (_a83 = pn(e2[0], Ci, 7)) == null ? void 0 : _a83.l()) == null ? void 0 : _b.g()) ?? /* @__PURE__ */ new Map()).forEach((e3, n2) => {
...
var Dh = [0, ti, -1, ui];
var _a76;
var Bh = (_a76 = class extends nr {
  constructor() {
    super();
  }
}, __name(_a76, "Bh"), _a76);
var _a77;
var Gh = (_a77 = class extends nr {
  constructor(t2) {
    super(t2);
  }
}, __name(_a77, "Gh"), _a77);
...
var Wh = (_a81 = class {
  ...
  close() {
    var _a83;
    (_a83 = this.segmentationMasks) == null ? void 0 : _a83.forEach((t2) => {
      t2.close();
    });
  }
}, __name(_a81, "Wh"), _a81);
...
//# sourceMappingURL=vision_bundle-WGQNRF3G.js.map
