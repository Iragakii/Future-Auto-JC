...
`);
var L = /* @__PURE__ */ __name((t) => typeof t == "number" && !isNaN(t), "L");
var N = /* @__PURE__ */ __name((t) => typeof t == "string", "N");
var P = /* @__PURE__ */ __name((t) => typeof t == "function", "P");
var mt = /* @__PURE__ */ __name((t) => N(t) || L(t), "mt");
var B = /* @__PURE__ */ __name((t) => N(t) || P(t) ? t : null, "B");
var pt = /* @__PURE__ */ __name((t, o) => t === false || L(t) && t > 0 ? t : o, "pt");
var z = /* @__PURE__ */ __name((t) => (0, import_react.isValidElement)(t) || N(t) || P(t) || L(t), "z");
...
function $({ enter: t, exit: o, appendPosition: e = false, collapse: r2 = true, collapseDuration: s = 300 }) {
  return function({ children: a, position: d, preventExitTransition: c, done: T, nodeRef: g, isIn: v, playToast: x }) {
    ...
    return (0, import_react2.useLayoutEffect)(() => {
      let f = g.current, p = C.split(" "), b = /* @__PURE__ */ __name((n) => {
      ...
      let f = g.current, p = /* @__PURE__ */ __name(() => {
...
function yt({ closeToast: t, theme: o, ariaLabel: e = "close" }) {
  return import_react4.default.createElement("button", { className: `Toastify__close-button Toastify__close-button--${o}`, type: "button", onClick: /* @__PURE__ */ __name((r2) => {
    r2.stopPropagation(), t(true);
  }, "onClick"), "aria-label": e }, import_react4.default.createElement("svg", { "aria-hidden": "true", viewBox: "0 0 14 16" }, import_react4.default.createElement("path", { fillRule: "evenodd", d: "M7.71 8.23l3.75 3.75-1.48 1.48-3.75-3.75-3.75 3.75L1 11.98l3.75-3.75L1 4.48 2.48 3l3.75 3.75L9.98 3l1.48 1.48-3.75 3.75z" })));
}
__name(yt, "yt");
...
__name(gt, "gt");
var Xt = 1;
var at = /* @__PURE__ */ __name(() => `${Xt++}`, "at");
function _t(t, o, e) {
  let r2 = 1, s = 0, l = [], a = [], d = o, c = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Set(), g = /* @__PURE__ */ __name((i) => (T.add(i), () => T.delete(i)), "g"), v = /* @__PURE__ */ __name(() => {
    a = Array.from(c.values()), T.forEach((i) => i());
  }, "v"), x = /* @__PURE__ */ __name(({ containerId: i, toastId: n, updateId: u }) => {
    let h = i ? i !== t : t !== 1, m = c.has(n) && u == null;
    return h || m;
  }, "x"), C = /* @__PURE__ */ __name((i, n) => {
    c.forEach((u) => {
      var h;
      (n == null || n === u.props.toastId) && ((h = u.toggle) == null || h.call(u, i));
    });
  }, "C"), S = /* @__PURE__ */ __name((i) => {
    var n, u;
    (u = (n = i.props) == null ? void 0 : n.onClose) == null || u.call(n, i.removalReason), i.isActive = false;
  }, "S"), E = /* @__PURE__ */ __name((i) => {
  ...
  return { id: t, props: d, observe: g, toggle: C, removeToast: E, toasts: c, clearQueue: f, buildToast: /* @__PURE__ */ __name((i, n) => {
    if (x(n)) return;
  ...
  }, "buildToast"), setProps(i) {
    d = i;
  }, setToggle: /* @__PURE__ */ __name((i, n) => {
    let u = c.get(i);
    u && (u.toggle = n);
  }, "setToggle"), isToastActive: /* @__PURE__ */ __name((i) => {
    var n;
    return (n = c.get(i)) == null ? void 0 : n.isActive;
  }, "isToastActive"), getSnapshot: /* @__PURE__ */ __name(() => a, "getSnapshot") };
}
__name(_t, "_t");
var I = /* @__PURE__ */ new Map();
var F = [];
var st = /* @__PURE__ */ new Set();
var Vt = /* @__PURE__ */ __name((t) => st.forEach((o) => o(t)), "Vt");
var bt = /* @__PURE__ */ __name(() => I.size > 0, "bt");
function Qt() {
...
var G = /* @__PURE__ */ __name(({ theme: t, type: o, isLoading: e, ...r2 }) => import_react11.default.createElement("svg", { viewBox: "0 0 24 24", width: "100%", height: "100%", fill: t === "colored" ? "currentColor" : `var(--toastify-icon-color-${o})`, ...r2 }), "G");
function ao(t) {
...
var lo = /* @__PURE__ */ __name((t) => t in W, "lo");
...
var K = /* @__PURE__ */ __name((t, o = false) => ({ enter: `Toastify--animate Toastify__${t}-enter`, exit: `Toastify--animate Toastify__${t}-exit`, appendPosition: o }), "K");
var lt = $(K("bounce", true));
var mo = $(K("slide", true));
var po = $(K("zoom"));
var uo = $(K("flip"));
var _o = { position: "top-right", transition: lt, autoClose: 5e3, closeButton: true, pauseOnHover: true, pauseOnFocusLoss: true, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light", "aria-label": "Notifications Alt+T", hotKeys: /* @__PURE__ */ __name((t) => t.altKey && t.code === "KeyT", "hotKeys") };
function Lt(t) {
  ...
  }, [C]), import_react6.default.createElement("section", { ref: l, className: "Toastify", id: x, onMouseEnter: /* @__PURE__ */ __name(() => {
    e && (s(false), y.pause());
  }, "onMouseEnter"), onMouseLeave: E, "aria-live": "polite", "aria-atomic": "false", "aria-relevant": "additions text", "aria-label": o["aria-label"] }, a((f, p) => {
