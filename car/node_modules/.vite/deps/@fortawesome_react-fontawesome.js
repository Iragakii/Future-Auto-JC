...
function _wrapRegExp() {
  _wrapRegExp = /* @__PURE__ */ __name(function(e2, r3) {
...
var emptyCanonicalIcon = /* @__PURE__ */ __name(() => {
  return {
    prefix: null,
    iconName: null,
    rest: []
...
__name(getFamilyId, "getFamilyId");
...
__name(moveNonFaClassesToRest, "moveNonFaClassesToRest");
function sortedUniqueValues(arr) {
  return arr.sort().filter((value, index, arr2) => {
    return arr2.indexOf(value) === index;
  });
}
__name(sortedUniqueValues, "sortedUniqueValues");
...
__name(applyShimAndAlias, "applyShimAndAlias");
...
__name(getDefaultCanonicalPrefix, "getDefaultCanonicalPrefix");
var _Library = class _Library {
  constructor() {
    this.definitions = {};
  }
  add() {
...
var autoReplace = /* @__PURE__ */ __name(function() {
  let params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  const {
...
var begin = /* @__PURE__ */ __name((name) => {
  p$2.mark("".concat(preamble, " ").concat(name, " begins"));
  return () => end(name);
}, "begin");
var end = /* @__PURE__ */ __name((name) => {
...
__name(getKnownPrefixes, "getKnownPrefixes");
...
var render = /* @__PURE__ */ __name(function(iconDefinition) {
  let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  const {
    transform = meaninglessTransform,
    symbol = false,
...
var parseTransformString = /* @__PURE__ */ __name((transformString) => {
  let transform = {
    size: 16,
    x: 0,
    y: 0,
